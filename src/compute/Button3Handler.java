...
//					table.getItems().remove(selectedItem);   
	...
	private void completeWindow()
	{
		...
		alert.setTitle("Επιτυχής Ενημέρωση");
		alert.setHeaderText(null);
		//alert.setContentText("Ενημερώθηκαν επιτυχώς "+changes3.size()+" παραγγελίες");
	...
	private void uncompleteWindow()
	{
		...
		alert.setContentText("Δεν έχει επιλεχθεί ή τροποποιηθεί καμία παραγγελία ώστε να γίνει εκτέλεση");
	...
	private void emptyDate(Order order) throws SQLException
	{
		...
		alert.setContentText("Η 'Ημερομηνία Εκτέλεσης' είναι κενή!\nΠιέστε το πλήκτρο 'οκ' για να συμπληρωθούν αυτόματα με την τωρινή ημερομηνία\nΠιέστε το πλήκτρο ΄cancel για ακύρωση΄");
