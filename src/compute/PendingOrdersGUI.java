...
public class PendingOrdersGUI 
{
    ...
    private Button button1;	//Αλλαγή Ημερομηνίας Δημιουργίας
	private Button button2; //Αλλαγή Ημερομηνίας Εκτέλεσης
	private Button button3; //Εκτέλεση
	private Button button4; //Ακύρωση
	private Button button5; //Αλλαγή Αριθμού Αποστολής
	private Button button6; //Ανανέωση
	private Button button7; //Άδειασμα Βάσης
...
//        ExecutionDate.setCellValueFactory(new PropertyValueFactory<Order, String>("DateCreation"));      
	...
	private void alertWindow()
	{
    	...
    	alert.setTitle("Σφαλμα κατά την αποθήκευση");
    	alert.setHeaderText("Πρόβλημα με τον τύπο");
    	alert.setContentText("Πιθανόν ο τύπος που εισάγατε να είναι λανθασμένος");
    	alert.showAndWait();
	}
}