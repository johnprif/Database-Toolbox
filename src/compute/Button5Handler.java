...
public class Button5Handler implements EventHandler<ActionEvent>
{
	...
	public void handle(ActionEvent arg0)
	{
		...
		try {
			checkInlabel = new Label("Εισάγεται τον επιθυμητό αριθμό αποστολής:");
	...
	private void warningWindowForFlag(String text)
	{
    	...
    	alert.setContentText("Παρακαλώ εισάγετε έναν έγκυρο Αριθμό Αποστολής πρωτού συνεχίσετε\nΕπιτρέπονται μόνο αριθμοί μέχρι 7 ψηφία μεγαλύτεροι του μηδέν και μικρότεροι του 9999999'");
    	alert.showAndWait();
	}
	...
	private void maxNumberWindow(String text)
	{
		Alert alert = new Alert(Alert.AlertType.INFORMATION);
    	alert.setTitle("Αριθμός Αποστολής");
    	alert.setHeaderText("Μέγιστη καταχώρηση\nΕπιτυχής Ενημέρωση!");
    	alert.setContentText("Ο Αριθμός Αποστολής '" + text +"' ενημερώθηκε επιτυχώς!\nΗ τρέχουσα παραγγελία θα ενημερωθεί με αυτόν το αριθμό\nΕπειδή όμως καταχωρήσατε τον μέγιστο Αριθμό Αποστολής δεν θα προσαυξηθεί κατά 1 όπως συνήθως αλλά θα καταχωρηθεί η τιμή 1 αυτόματα!");
    	alert.showAndWait();
	}
}
